...
const VideoCard = ({ title, video, thumbnail, creator, id, isSaved, showOptions = true }) => {
            ...
            <View className='flex-row gap-3 items-start'>
                <View className='justify-center items-center flex-1 flex-row'>
                    <View className='w-[46px] h-[46px] rounded-lg border border-secondary justify-center items-center p-0.5'>
                        <Image source={{ uri: 'https://gravatar.com/avatar/fb7ba2bc65d6d8227f4cb8328d780176?s=400&d=identicon&r=g'}}
